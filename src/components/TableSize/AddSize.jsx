...
import { addAsyncSize } from '@/redux/size/sizeAction';
...
export const AddSize = ({ setLoadingTable, open, onClose, form }) => {
  ...
  const onFinish = async values => {
    ...
    await dispatch(addAsyncSize(mapData));
    onClose();
                      ...
                      rules={[
                        {
                          required: true,
                          whitespace: true,
                          message: 'Please input size name or delete this field.',
                        },
                      ]}
                      noStyle
                    >
